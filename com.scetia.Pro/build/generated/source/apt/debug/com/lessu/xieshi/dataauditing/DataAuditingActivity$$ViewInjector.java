...
public class DataAuditingActivity$$ViewInjector {
  public static void inject(Finder finder, final com.lessu.xieshi.dataauditing.DataAuditingActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131558787, "method 'auditingAllButtonDidClick'");
    ...
    view = finder.findRequiredView(source, 2131558786, "method 'auditingChoosenButtonDidClick'");
    view.setOnClickListener(
      new android.view.View.OnClickListener() {
        @Override public void onClick(
          android.view.View p0
