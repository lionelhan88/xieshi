...
public class ImageGalleryActivity$$ViewInjector {
  public static void inject(Finder finder, final com.lessu.xieshi.uploadpicture.ImageGalleryActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131558874, "method 'leftButtonDidPress'");
    ...
    view = finder.findRequiredView(source, 2131558875, "method 'rightButtonDidPress'");
    view.setOnClickListener(
      new android.view.View.OnClickListener() {
        @Override public void onClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131558877, "method 'downloadButtonDidPress'");
    view.setOnClickListener(
      new android.view.View.OnClickListener() {
        @Override public void onClick(
          android.view.View p0
