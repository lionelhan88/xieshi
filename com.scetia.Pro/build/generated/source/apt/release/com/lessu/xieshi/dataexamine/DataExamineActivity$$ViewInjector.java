...
public class DataExamineActivity$$ViewInjector {
  public static void inject(Finder finder, final com.lessu.xieshi.dataexamine.DataExamineActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131558793, "method 'auditingAllButtonDidClick'");
    ...
    view = finder.findRequiredView(source, 2131558792, "method 'auditingChoosenButtonDidClick'");
    view.setOnClickListener(
      new android.view.View.OnClickListener() {
        @Override public void onClick(
          android.view.View p0
