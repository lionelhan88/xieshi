...
public class LoginActivity$$ViewInjector {
  public static void inject(Finder finder, final com.lessu.xieshi.login.LoginActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131558908, "method 'loginButtonDidPress'");
    ...
    view = finder.findRequiredView(source, 2131558906, "method 'userNameEditTextFocus'");
    ...
    view = finder.findRequiredView(source, 2131558907, "method 'passWordEditTextTextFocus'");
    view.setOnFocusChangeListener(
      new android.view.View.OnFocusChangeListener() {
        @Override public void onFocusChange(
          android.view.View p0,
