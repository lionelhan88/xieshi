...
public class ValidateActivity$$ViewInjector {
  public static void inject(Finder finder, final com.lessu.xieshi.login.ValidateActivity target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131231488, "method 'validateButtonDidPress'");
    view.setOnClickListener(
      new android.view.View.OnClickListener() {
        @Override public void onClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131231146, "method 'phoneNumEditTextChanged'");
