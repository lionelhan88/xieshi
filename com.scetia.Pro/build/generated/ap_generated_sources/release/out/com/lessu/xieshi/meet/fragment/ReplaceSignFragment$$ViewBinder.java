...
public class ReplaceSignFragment$$ViewBinder<T extends ReplaceSignFragment> implements ViewBinder<T> {
  @Override
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131231342, "field 'rlReplace'");
    target.rlReplace = finder.castView(view, 2131231342, "field 'rlReplace'");
    return unbinder;
  }
  ...
  protected static class InnerUnbinder<T extends ReplaceSignFragment> implements Unbinder {
    private T target;
