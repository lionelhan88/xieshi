...
public class MeetingDetailActivity$$ViewBinder<T extends MeetingDetailActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131230890, "field 'btMeetingIsConfirm' and method 'onViewClicked'");
    target.btMeetingIsConfirm = finder.castView(view, 2131230890, "field 'btMeetingIsConfirm'");
    unbinder.view2131230890 = view;
    ...
    view = finder.findRequiredView(source, 2131231200, "field 'meetingDetailPhoto' and method 'onViewClicked'");
