...
public class DataExamineActivity$$ViewBinder<T extends DataExamineActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131230999, "method 'auditingAllButtonDidClick'");
    unbinder.view2131230999 = view;
    ...
    view = finder.findRequiredView(source, 2131231000, "method 'auditingChoosenButtonDidClick'");
