...
public class DataAuditingActivity$$ViewBinder<T extends DataAuditingActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131230860, "method 'auditingAllButtonDidClick'");
    ...
    view = finder.findRequiredView(source, 2131230861, "method 'auditingChoosenButtonDidClick'");
    unbinder.view2131230861 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
