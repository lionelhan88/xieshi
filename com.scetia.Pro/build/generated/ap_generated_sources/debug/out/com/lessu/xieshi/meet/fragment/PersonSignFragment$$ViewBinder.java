...
public class PersonSignFragment$$ViewBinder<T extends PersonSignFragment> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends PersonSignFragment> implements Unbinder {
    private T target;
