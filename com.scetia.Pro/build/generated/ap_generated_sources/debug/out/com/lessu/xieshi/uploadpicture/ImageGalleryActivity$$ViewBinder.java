...
public class ImageGalleryActivity$$ViewBinder<T extends ImageGalleryActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131231048, "method 'leftButtonDidPress'");
    unbinder.view2131231048 = view;
    ...
    view = finder.findRequiredView(source, 2131231186, "method 'rightButtonDidPress'");
    unbinder.view2131231186 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
    ...
    view = finder.findRequiredView(source, 2131230944, "method 'downloadButtonDidPress'");
    unbinder.view2131230944 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
