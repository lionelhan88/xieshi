...
public class ServiceActivity$$ViewBinder<T extends ServiceActivity> implements ViewBinder<T> {
  ...
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131231247, "method 'telecomButtonDidClick'");
    unbinder.view2131231247 = view;
    ...
    view = finder.findRequiredView(source, 2131231493, "method 'unicomButtonDidClick'");
    unbinder.view2131231493 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
  ...
  protected static class InnerUnbinder<T extends ServiceActivity> implements Unbinder {
    ...
    protected void unbind(T target) {
      ...
      view2131231493.setOnClickListener(null);
    }
  }
}
