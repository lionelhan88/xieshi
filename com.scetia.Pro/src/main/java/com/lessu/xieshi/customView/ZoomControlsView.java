package com.lessu.xieshi.customView;
...
public class ZoomControlsView extends LinearLayout implements OnClickListener{
	...
	private void controlZoomShow(){
		...
		if(zoom>=maxZoomLevel){
			inBtn.setBackgroundResource(R.drawable.jiaawuxiao);
		...
		if(zoom<=minZoomLevel){
			outBtn.setBackgroundResource(R.drawable.jianawuxiao);
