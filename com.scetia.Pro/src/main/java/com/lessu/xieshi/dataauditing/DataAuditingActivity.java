...
public class DataAuditingActivity extends XieShiSlidingMenuActivity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.data_auditing_activity);
		this.setTitle("记录审核");
	...
	/*	EasyAPI.apiConnectionAsync(DataAuditingActivity.this, true, false, ApiMethodDescription.get(uri), params, new EasyAPI.ApiFastSuccessFailedCallBack() {
			...
			public String onFailed(ApiError error) {
				// TODO Auto-generated method stub
				Toast.makeText(DataAuditingActivity.this,"当前没有相对应的数据!",Toast.LENGTH_SHORT).show();
				return null;
			}
		});*/
				...
				pageController.setPageinfoAdapter(new PageInfoAdapterInterface(){
					...
					public PageInfo adapter(JsonElement input) {
						...
						if(!resIsSuccess){
							...
							Toast.makeText(DataAuditingActivity.this, message, Toast.LENGTH_SHORT).show();
							return pageInfo;
						}
