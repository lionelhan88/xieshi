...
//        titleButton.setBackgroundColor(Color.RED);
        ...
        layoutParams.leftMargin  = DensityUtil.dp2px(getContext(), 12);
        layoutParams.rightMargin = DensityUtil.dp2px(getContext(), 12);
...
//				DensityUtil.dp2px(getContext(), getImageHeightDp())));
        titleButton.setImageHeight(DensityUtil.dp2px(getContext(),imageSizeDp));
...
//    - (CGFloat)backButtonBackgroundVerticalPositionAdjustmentForBarMetrics:(UIBarMetrics)barMetrics NS_AVAILABLE_IOS(5_0) UI_APPEARANCE_SELECTOR;
    ...
    public static BarButtonItem backBarButtonItem(Context context){
        ...
        //backItem.titleButton.setImage(R.drawable.icon_back_n);
