...
public class LSAlert {
    ...
    public static void showAlert(Context context,
        ...
        showAlert(context, title, detail, confirmButtonTitle, null, isTouchCancel, callback);
    }
    ...
    public static AlertDialog showAlert(Context context
        ...
        builder.setPositiveButton(confirmButtonTitle, (dialog, which) -> {
            if (callback != null) {
                callback.onConfirm();
            }
        });
        if (cancelButtonTitle != null) {
            builder.setNegativeButton(cancelButtonTitle, (dialogInterface, i) -> {
                if (callback != null) {
                    callback.onCancel();
                }
            });
    ...
    public static AlertDialog showDialog(Context context, String title, String detail, String confirmButtonTitle, String cancelButtonTitle, final DialogCallback callback) {
        AlertDialog alertDialog = new AlertDialog.Builder(context).
                setTitle(title).
                setMessage(detail).
                setPositiveButton(confirmButtonTitle, (dialog, which) -> {
                    if (callback != null) {
                        callback.onConfirm();
                    }
                })
                .setNegativeButton(cancelButtonTitle, (dialogInterface, i) -> {
                    if (callback != null) {
                        callback.onCancel();
                    }
                })
    ...
    public static void showTransparentDialog(Context context, String title, View view, String confirmButtonTitle, final AlertCallback callback) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context).
                ...
                setView(view);
        if (callback != null) {
            builder.setPositiveButton(confirmButtonTitle, (dialogInterface, i) -> callback.onConfirm());
        }
    ...
    public static void showDialogSingleChoice(Context context, String title, @DrawableRes int iconId, String[] arr,String cancelButtonText, final SelectItemCallback callback) {
        AlertDialog alertDialog = new AlertDialog.Builder(context).
                setTitle(title).
                setIcon(iconId).
                setItems(arr, (dialog, which) -> callback.selectItem(which))
