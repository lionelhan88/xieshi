...
public class MyUpdateUtil {
    ...
    public MyUpdateUtil showNormalUpdateDialog(UpdateInfo updateInfo) {
        return showNormalUpdateDialog(updateInfo, updateTitle, "从应用商店下载", "立即下载", "取消", false,null);
    }

    public MyUpdateUtil showNormalUpdateDialog(UpdateInfo updateInfo, String titleStr, String downloadByShopStr, String downloadNowStr, String cancelStr) {
        return showNormalUpdateDialog(updateInfo, titleStr, downloadByShopStr, downloadNowStr, cancelStr, false,null);
    }

    private boolean isForced = false;

    public MyUpdateUtil showNormalUpdateDialog(final UpdateInfo updateInfo, String titleStr, final String downloadByShopStr, String downloadNowStr, String cancelStr, final boolean isForced,
        ...
        if (isForced) {
            alertDialog.setButton(BUTTON_NEGATIVE, cancelStr,listener);
        }else{
    ...
    public MyUpdateUtil setOnDownloadListener(OnDownloadListener onDownloadListener) {
    ...
    public void showProgressDialog() {
        ...
        if(isForced){
            progressDialog.setTitle("点击\"取消下载\"则退出程序！");
        }else {
    ...
    public MyUpdateUtil setForced(boolean forced) {
        isForced = forced;
        return this;
    }
}
