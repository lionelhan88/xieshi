...
public class EasyAPI {
    ...
    public static ApiConnection apiConnectionAsync(final Context context,final boolean indicator,boolean useCache,ApiMethodDescription method,HashMap<String,Object> params, final ApiFastSuccessFailedCallBack callBack) {
    ...
    public static ApiConnection apiConnectionAsync(ApiMethodDescription method,HashMap<String,Object> params, final ApiFastSuccessFailedCallBack callBack) {
        ApiConnection connection = ApiBase.sharedInstance().getConnectionWithApiMethod(method,params);
        connection.setCallbacks(new ApiConnection.ApiConnectionCallback() {
