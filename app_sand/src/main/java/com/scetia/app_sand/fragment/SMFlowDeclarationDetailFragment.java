...
import com.scetia.Pro.common.Util.FullScreenDialog;
...
import com.scetia.app_sand.viewmodel.SMFlowDeclarationDetailViewModel;
...
public class SMFlowDeclarationDetailFragment extends BaseVMFragment<SMFlowDeclarationDetailViewModel> {
    ...
    @BindView(R2.id.flow_declaration_detail_record_number)
    TextView flowDeclarationDetailRecordNumber;
    @BindView(R2.id.flow_declaration_detail_record_name)
    TextView flowDeclarationDetailRecordName;
    @BindView(R2.id.flow_declaration_detail_ship_name)
    EditText flowDeclarationDetailShipName;
    @BindView(R2.id.flow_declaration_detail_sand_name)
    TextView flowDeclarationDetailSandName;
    @BindView(R2.id.flow_declaration_detail_sand_spec)
    TextView flowDeclarationDetailSandSpec;
    @BindView(R2.id.flow_declaration_detail_wharf_name)
    EditText flowDeclarationDetailWharfName;
    @BindView(R2.id.flow_declaration_detail_sale_user)
    TextView flowDeclarationDetailSaleUser;
    @BindView(R2.id.flow_declaration_detail_sale_number)
    EditText flowDeclarationDetailSaleNumber;
    @BindView(R2.id.bt_flow_declaration_detail_save)
    Button btFlowDeclarationDetailSave;
    @BindView(R2.id.bt_flow_declaration_detail_declaration)
    Button btFlowDeclarationDetailDeclaration;
    @BindView(R2.id.flow_declaration_detail_test_parameter)
    ...
    //记录船名
    @OnTextChanged(value = R2.id.flow_declaration_detail_ship_name, callback = OnTextChanged.Callback.AFTER_TEXT_CHANGED)
    public void shipNameTextChanged(CharSequence s) {
        viewModel.getFlowDeclarationBean().setShipName(s.toString());
    }

    //记录码头
    @OnTextChanged(value = R2.id.flow_declaration_detail_wharf_name, callback = OnTextChanged.Callback.AFTER_TEXT_CHANGED)
    public void wharfNameTextChanged(CharSequence s) {
        viewModel.getFlowDeclarationBean().setTerminalName(s.toString());
    }

    //记录销售数量
    @OnTextChanged(value = R2.id.flow_declaration_detail_sale_number, callback = OnTextChanged.Callback.AFTER_TEXT_CHANGED)
    ...
    @OnClick({R2.id.bt_flow_declaration_detail_save, R2.id.bt_flow_declaration_detail_declaration,
            R2.id.flow_declaration_detail_record_number, R2.id.flow_declaration_detail_sand_name,
            R2.id.flow_declaration_detail_sand_spec, R2.id.flow_declaration_detail_test_parameter,
            R2.id.flow_declaration_detail_sale_user})
    public void onViewClicked(View view) {
        int id = view.getId();
        if (id == R.id.bt_flow_declaration_detail_save) {
        ...
        } else if (id == R.id.bt_flow_declaration_detail_declaration) {//界面设计要求：可以从当前流转记录直接进行委托D
        ...
        } else if (id == R.id.flow_declaration_detail_sand_name) {
        ...
        } else if (id == R.id.flow_declaration_detail_sand_spec) {
        ...
        } else if (id == R.id.flow_declaration_detail_record_number) {//备案证号
        ...
        } else if (id == R.id.flow_declaration_detail_sale_user) {//选择销售对象
    ...
    @OnClick(R2.id.flow_declaration_detail_test_parameter)
